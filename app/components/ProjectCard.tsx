...
export default function ProjectCard({
  ...
  onApprove,
  onDelete
}: ProjectCardProps) {const { t } = useTranslation();
    ...
    <>
      ...
      <div className="p-6">
        ...
        <a
            ...
            className="inline-flex items-center text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors group/link">{t("바로가기")}
        ...
        {showActions &&
          <div className="mt-6 pt-6 border-t border-slate-700 flex gap-3">
            ...
            <button
              onClick={onApprove}
              className="flex-1 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white px-4 py-2.5 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg shadow-green-500/30">{t("✓ 승인")}
            ...
            <button
              onClick={onDelete}
              className={`${!isApproved && onApprove ? 'flex-1' : 'w-full'} bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white px-4 py-2.5 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg shadow-red-500/30`}>{t("✗ 삭제")}
            ...
            <div className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-t border-slate-700">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg shadow-blue-500/30">{t("사이트 방문하기")}
